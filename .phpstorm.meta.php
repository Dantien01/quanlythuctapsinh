...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\quanlythuctapsinh\quan-ly-thuc-tap-sinh\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\quanlythuctapsinh\\quan-ly-thuc-tap-sinh\\public\\storage',
...
'signed','throttle','verified','role','profile.approved',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','livewire.update','livewire.upload-file',
'livewire.preview-file','home','dashboard','profile.edit',
'profile.update','profile.destroy','admin.index','admin.dashboard','admin.schools.index',
'admin.schools.create','admin.schools.store','admin.schools.show','admin.schools.edit','admin.schools.update',
'admin.schools.destroy','admin.majors.index','admin.majors.create','admin.majors.store','admin.majors.show',
'admin.majors.edit','admin.majors.update','admin.majors.destroy','admin.users.index','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.users.approve','admin.users.reject','admin.schedules.index',
'admin.schedules.create','admin.schedules.store','admin.schedules.show','admin.schedules.edit','admin.schedules.update',
'admin.schedules.destroy','register','login',
...
'admin.majors.create','admin.majors.edit','admin.majors.index','admin.schools.create','admin.schools.edit',
'admin.schools.index','admin.users.edit','admin.users.index','auth.confirm-password','auth.forgot-password',
'auth.login','auth.register','auth.reset-password','auth.verify-email','components.action-message',
...
'components.layouts.auth.simple','components.layouts.auth.split','components.modal','components.nav-link','components.placeholder-pattern',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.settings.layout','components.text-input',
...
'flux.navlist.group','layouts.app','layouts.guest','layouts.navigation','livewire.auth.confirm-password',
...
'livewire.settings.appearance','livewire.settings.delete-user-form','livewire.settings.password','livewire.settings.profile','partials.head',
'partials.settings-heading','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
